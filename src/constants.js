...
export const DEFAULT_TASKS = [
  ...
  { id:'wi4',  name:'Finishing Items — Paint + Special (14d proc + 45d install = 45d)', team:'projects', category:'wbs_int', duration:45, deps:['c3e','c3f'], status:'not_started', priority:'P2',
    plannedEnd:xl(46282),
    notes:'Final finishing details will decide actual timelines. Deps: Finishing Items Layout. FSA: ' + xl(46216) },
  { id:'wi5',  name:'LGD Entrance Portal — PVD Cladding (21d proc + 3d install = 24d)', team:'projects', category:'wbs_int', duration:24, deps:['c2f'], status:'not_started', priority:'P1',
    plannedEnd:xl(46261),
    notes:'Deps: PVD Details, Elevation Drawing, Joinery Details. FSA: ' + xl(46207) },
  { id:'wi6',  name:'POP + Putty + Internal Painting (14d proc + 45d install = 45d)', team:'projects', category:'wbs_int', duration:45, deps:['wi1'], status:'not_started', priority:'P1',
    plannedEnd:xl(46282),
    notes:'Start only after: All Ceiling MEP Works, Metal Truss, Barrisol Lights, Light Fixture Supports, Ticker LED. FSA: ' + xl(46193) },
  { id:'wi7',  name:'Toilet Modular Partition (30d proc + 7d install = 37d)', team:'projects', category:'wbs_int', duration:37, deps:['wr9','wr10'], status:'not_started', priority:'P2',
    plannedEnd:xl(46273),
  ...
  { id:'we3',  name:'UPS (30d proc + 3d install = 33d)', team:'projects', category:'wbs_elec', duration:33, deps:['ms1'], status:'not_started', priority:'P1',
    plannedEnd:xl(46289),
    notes:'Deps: SLD, Lighting Layout, IT Layout, HVAC Drainage Pump. FSA: ' + xl(46211) },
  { id:'we4',  name:'HVAC High Side Electrical Cabling & Earthing (7d proc + 14d install = 21d)', team:'projects', category:'wbs_elec', duration:21, deps:['ms4'], status:'not_started', priority:'P1',
  ...
  // ── PLUMBING (WBS) ───────────────────────────────────────────────────────
  { id:'wp1',  name:'Washroom — Sanitary Fixtures & Faucets (30d proc + 7d install = 37d)', team:'projects', category:'wbs_plumb', duration:37, deps:['wr9','wr10','wr7'], status:'not_started', priority:'P1',
    plannedEnd:xl(46289),
  ...
  // ── FIRE FIGHTING (WBS) ──────────────────────────────────────────────────
  { id:'wf1',  name:'Sprinkler + Smoke Detectors (14d proc + 7d install = 21d)', team:'projects', category:'wbs_fire', duration:21, deps:['m2c','m2d'], status:'not_started', priority:'P1',
    plannedEnd:xl(46289),
    notes:'Deps: Sprinkler Layout, RCP, False Ceiling Layout. FSA: ' + xl(46215) },
  { id:'wf2',  name:'Fire Alarm System (21d proc + 7d install = 28d)', team:'projects', category:'wbs_fire', duration:28, deps:['m2a','m2b'], status:'not_started', priority:'P1',
    plannedEnd:xl(46289),
    notes:'Deps: FAS Drawing (SD + RI). FSA: ' + xl(46215) },
  { id:'wf3',  name:'RF/RFID Antennas (21d proc + 3d install = 24d)', team:'projects', category:'wbs_fire', duration:24, deps:['m3i','m3j'], status:'not_started', priority:'P2',
    plannedEnd:xl(46289),
  ...
  { id:'wl1',  name:'Track Mounted Linear Downlights + Special Lights (30d proc + 14d install = 44d)', team:'projects', category:'wbs_light', duration:44, deps:['m3c','m3d'], status:'not_started', priority:'P1',
    plannedEnd:xl(46289),
    notes:'Deps: Lighting Layout incl. Barrisol/Special Lights, RCP, C/S Drawing, BOQ. FSA: ' + xl(46215) },

  // ── SIGNAGE (WBS) ────────────────────────────────────────────────────────
  { id:'ws1',  name:'External Signages (30d proc + 10d install = 40d)', team:'projects', category:'wbs_sign', duration:40, deps:['ms8','c2a'], status:'not_started', priority:'P1',
    plannedEnd:xl(46268),
  ...
  { id:'ws2',  name:'Internal Signages (30d proc + 10d install = 40d)', team:'projects', category:'wbs_sign', duration:40, deps:['ms8','c3m','c3n'], status:'not_started', priority:'P1',
    plannedEnd:xl(46289),
    notes:'Deps: Signage Docket, Internal Elevation incl. signages, Electrical Layout. FSA: ' + xl(46235) },

  // ── VIDEO & MEDIA (WBS) ──────────────────────────────────────────────────
  { id:'wm1',  name:'Internal LED Screens — Straight (45d proc + 10d install = 55d)', team:'projects', category:'wbs_media', duration:55, deps:['ms6'], status:'not_started', priority:'P1',
    plannedEnd:xl(46289),
  ...
  { id:'wm2',  name:'External LED Screens / Ticker (45d proc + 21d install = 66d)', team:'projects', category:'wbs_media', duration:66, deps:['ms6'], status:'not_started', priority:'P1',
    plannedEnd:xl(46289),
    notes:'⚠️ CRITICAL LEAD ITEM. FSA: ' + xl(46209) + '. Procurement start: ' + xl(46223) },
  { id:'wm3',  name:'TV Screens (7d proc + 3d install = 10d)', team:'projects', category:'wbs_media', duration:10, deps:['m3a','m3b'], status:'not_started', priority:'P3',
    plannedEnd:xl(46289),
    notes:'FSA: ' + xl(46265) },

  // ── AUDIO & MUSIC (WBS) ──────────────────────────────────────────────────
  { id:'wa1',  name:'Music System (21d proc + 3d install = 24d)', team:'projects', category:'wbs_audio', duration:24, deps:['ms9','m3e','m3f'], status:'not_started', priority:'P2',
    plannedEnd:xl(46281),
