...
export const PARENT_GROUPS = [
  ...
  { id:'grp_civil_wbs', name:'Civil & Interior Works',                     team:'projects', category:'wbs_civil', icon:'',
  ...
  { id:'grp_hvac_wbs',  name:'HVAC',                                       team:'projects', category:'wbs_hvac',  icon:'',
    children:['wh1','wh2'] },
